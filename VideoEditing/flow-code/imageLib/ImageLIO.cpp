...
void WriteFileTGA(CImageL img, const char* filename)
{
...
void ReadImage (CImageL& img, const char* filename)
{
	if (filename == NULL)
...
void WriteImage(CImageL& img, const char* filename)
{
	if (filename == NULL)
...
void ReadImageVerb(CImageL& img, const char* filename, int verbose) {
	if (verbose)
...
void WriteImageVerb(CImageL& img, const char* filename, int verbose) {
	if (verbose)
