...
CImageL::CImageL(CShape s, const type_info& ti, int cS)
{
    SetDefaults();
    ReAllocate(s, ti, cS, 0, true, 0);
}

void CImageL::ReAllocate(CShape s, const type_info& ti, int bandSize,
...
void CImageL::SetSubImage(int x, int y, int width, int height)
{
...
void CImageL::SetPixels(void *val_ptr)
{
