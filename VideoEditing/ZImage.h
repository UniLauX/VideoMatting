...
public:
	ZImage()
		:m_map(NULL),m_iWidth(0),m_iHeight(0),m_iChannel(0),m_iEffectWidth(0),m_iImageSize(0)
	{
	};
...
public:
	...
	ZVector(int iSize,int channel=1)
	{
...
typedef std::vector<ZFloatImage*> FloatImgList;
typedef std::vector<ZByteImage*> ByteImgList;
typedef std::vector<ZIntImage*> IntImgList;
