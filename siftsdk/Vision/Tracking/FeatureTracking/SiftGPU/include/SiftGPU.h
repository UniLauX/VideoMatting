...
public:
	...
	//Copy the SIFT keypoint dog value to user's array
	SIFTGPU_EXPORT virtual void GetFeatureDogValueVector_ZXQI(float * keysdogv);                       // added by zxqi 09/22/2009
...
public:
	...
	SIFTGPU_EXPORT void destroyOpenGL();//by zxqi   2009/12/3
};
